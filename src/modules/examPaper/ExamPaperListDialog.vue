  ...
  <v-dialog v-model="model" max-width="1200" :scrim="true" close-on-esc close-on-back>
    <v-card class="fixed-dialog">
      ...
      <v-card-text class="dialog-body">
        ...
        <ExamPaperListView :mode="mode" @selected="onPick" />
      </v-card-text>
...
<script setup lang="ts">
  ...
  import ExamPaperListView from './ExamPaperListView.vue';
  ...
  function onPick(examPaper: ExamPaper) {
    emit('selected', examPaper);
